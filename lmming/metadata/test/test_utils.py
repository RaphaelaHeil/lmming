...
class BuildReportIdentifierTests(TestCase):
    ...
    def test_annualReportSingleYear(self):
        a = {"type": Report.DocumentType.ANNUAL_REPORT, "date": 1910, "union_id": "01234",
             "page": 1}
        self.assertEquals("01234-ANNUAL_REPORT-1910", buildReportIdentifier(a))

    def test_annualReportDoubleYear(self):
        a = {"type": Report.DocumentType.ANNUAL_REPORT, "date": [1910, 1911], "union_id": "01234",
             "page": 1}
        self.assertEquals("01234-ANNUAL_REPORT-1910-1911", buildReportIdentifier(a))

    def test_financialStatementSingleYear(self):
        a = {"type": Report.DocumentType.FINANCIAL_STATEMENT, "date": 1910, "union_id": "01234",
             "page": 1}
        self.assertEquals("01234-FINANCIAL_STATEMENT-1910", buildReportIdentifier(a))

    def test_financialStatementDoubleYear(self):
        a = {"type": Report.DocumentType.FINANCIAL_STATEMENT, "date": [1910, 1911], "union_id": "01234",
             "page": 1}
        self.assertEquals("01234-FINANCIAL_STATEMENT-1910-1911", buildReportIdentifier(a))
    ...
    def test_multiTypeSingleYear(self):
        a = {"type": [Report.DocumentType.ANNUAL_REPORT, Report.DocumentType.FINANCIAL_STATEMENT], "date": 1910,
             "union_id": "01234", "page": 1}
        self.assertEquals("01234-ANNUAL_REPORT-FINANCIAL_STATEMENT-1910", buildReportIdentifier(a))

    def test_multiTypeDoubleYear(self):
        a = {"type": [Report.DocumentType.ANNUAL_REPORT, Report.DocumentType.FINANCIAL_STATEMENT],
             "date": [1910, 1911], "union_id": "01234", "page": 1}
        self.assertEquals("01234-ANNUAL_REPORT-FINANCIAL_STATEMENT-1910-1911", buildReportIdentifier(a))
